...
-- composite primary key violation yyyy-mm-dd
...
INSERT INTO unique_constraint_example (first_name, last_name, email)
VALUES ('Sasha', 'Lee', 'slee@example.org');--email should be unique
...
FROM 'C:\edb\city_of_new_york.csv'
