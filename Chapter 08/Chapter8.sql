...
FROM 'C:\edb\pls_fy2014_pupld14a.csv'
...
FROM 'C:\edb\pls_fy2009_pupld09a.csv'
WITH (FORMAT CSV, HEADER);
...
FROM pls_fy2014_pupld14a;--not null data

SELECT libname, count(libname)
FROM pls_fy2014_pupld14a
GROUP BY libname --duplicate data
ORDER BY count(libname) DESC;

-- location of every Oxford Public Library
SELECT libname, city, stabr
FROM pls_fy2014_pupld14a
WHERE libname = 'OXFORD PUBLIC LIBRARY';

-- most and fewest visits
...
-- total number of visits in 2014
SELECT sum(visits) AS visits_2014
FROM pls_fy2014_pupld14a
WHERE visits >= 0;

-- total number of visits in 2009
